# Stack — Category Campaign

**Campaign type:** Category
**Purpose (one line):** Deep-dive on a single category / range to drive browse + consideration.
...
| Step | Read / Do |
|------|-----------|
| Playbook | `../../../../Playbooks/Category-Playbook.md` — psychology, design direction, CTA & product strategy, KPIs, common mistakes |
| Generate prompt | `07-Prompt Library/Generate-Category-Campaign.md` |
...
- **Draft/** — work-in-progress HTML (`Stack-CAT`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `Stack-CAT-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
