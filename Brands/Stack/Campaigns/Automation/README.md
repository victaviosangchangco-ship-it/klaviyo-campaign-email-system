# Stack — Automation Campaign

**Campaign type:** Automation
**Purpose (one line):** Triggered/automated sends. NOTE: automated FLOWS live in the separate Klaviyo Flow project; use this folder only for automation-adjacent campaign content coordinated with that project.
...
| Step | Read / Do |
|------|-----------|
| Playbook | `../../../../Playbooks/Automation-Playbook.md` — psychology, design direction, CTA & product strategy, KPIs, common mistakes |
| Generate prompt | `07-Prompt Library/Generate-Weekly-Campaign.md` |
...
- **Draft/** — work-in-progress HTML (`Stack-AUTO`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `Stack-AUTO-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
