# Stack — Brand Story Campaign

**Campaign type:** Brand Story
**Purpose (one line):** Brand values / about / trust narrative; low product density, high credibility.
...
| Step | Read / Do |
|------|-----------|
| Playbook | `../../../../Playbooks/Brand-Story-Playbook.md` — psychology, design direction, CTA & product strategy, KPIs, common mistakes |
| Generate prompt | `07-Prompt Library/Generate-Brand-Story-Campaign.md` |
...
- **Draft/** — work-in-progress HTML (`Stack-STORY`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `Stack-STORY-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
