# Stack — Educational Campaign

**Campaign type:** Educational
**Purpose (one line):** How-to / compliance / buying-guide content; helpful, low-pressure.
...
| Step | Read / Do |
|------|-----------|
| Playbook | `../../../../Playbooks/Educational-Playbook.md` — psychology, design direction, CTA & product strategy, KPIs, common mistakes |
| Generate prompt | `07-Prompt Library/Generate-Educational-Campaign.md` |
...
- **Draft/** — work-in-progress HTML (`Stack-EDU`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `Stack-EDU-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
