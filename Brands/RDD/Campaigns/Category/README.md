...
- **Draft/** — work-in-progress HTML (`RDD-CAT`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `RDD-CAT-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
