# QA Report — RDD-2026-35

- **Brand:** RDD
- **Draft assessed:** v7
- **Generated:** 2026-08-08T06:37:20.147Z
...
| ✅ | anchor-balance | §6.23 | Anchors balanced (87). |
...
| ✅ | image-src | §8 | All 43 image src(s) are absolute HTTPS. |
| ✅ | image-dims | §6.6 | All images carry width & height attributes. |
| ✅ | gmail-clip | §8.3 | HTML is 88.8KB (well under 102KB clip). |
...
```json
{
  "candidateSource": "override:RDD-2026-35",
  "groups": [
    {
      "title": "Kids and Student Seating",
      "count": 2
    },
    {
    ...
    {
      "title": "Sit Stand and Study Desks",
      "count": 6
    },
    {
