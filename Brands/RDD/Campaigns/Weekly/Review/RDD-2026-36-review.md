# QA Report — RDD-2026-36

- **Brand:** RDD
- **Draft assessed:** v2
- **Generated:** 2026-08-12T07:35:09.770Z
...
| ✅ | anchor-balance | §6.23 | Anchors balanced (54). |
...
| ✅ | image-src | §8 | All 26 image src(s) are absolute HTTPS. |
| ✅ | image-dims | §6.6 | All images carry width & height attributes. |
| ✅ | gmail-clip | §8.3 | HTML is 60.5KB (well under 102KB clip). |
...
```json
{
  "candidateSource": "override:RDD-2026-36",
  "groups": [
    {
