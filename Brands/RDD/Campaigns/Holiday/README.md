...
- **Draft/** — work-in-progress HTML (`RDD-HOL`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `RDD-HOL-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
