...
- **Draft/** — work-in-progress HTML (`RDD-CLR`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `RDD-CLR-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
