...
- **Draft/** — work-in-progress HTML (`SS-STORY`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `SS-STORY-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
