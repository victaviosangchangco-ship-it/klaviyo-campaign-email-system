...
- **Draft/** — work-in-progress HTML (`SS-AUTO`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `SS-AUTO-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
