...
- **Draft/** — work-in-progress HTML (`SC-CAT`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `SC-CAT-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
