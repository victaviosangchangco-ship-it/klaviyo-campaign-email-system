...
- **Draft/** — work-in-progress HTML (`SC-EDU`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `SC-EDU-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
