...
- **Draft/** — work-in-progress HTML (`SC-LAUNCH`-YYYY-<id>-draft-vN.html).
...
## Naming
Final HTML: `SC-LAUNCH-YYYY-<id>.html` (see CLAUDE.md §10 for the id token per cadence/type).
